...
| Hosting (Firebase)                                          | Security headers (CSP, HSTS, `X-Content-Type-Options`, `Referrer-Policy`) set in `firebase.json`; `e2e/security-headers.spec.ts` checks they're present on the preview and that the app still renders under the CSP.                                                                                                                                                                                  |
